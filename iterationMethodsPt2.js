...
// Task 1
let tempGreaterThanOrEqual25 = temperatures.filter((temperature) => {
  if (temperature >= 25) {
    return true;
  }
});
console.log(tempGreaterThanOrEqual25);

// Task 2
let tempLessThan20 = temperatures.filter((temperature) => {
  if (temperature < 20) {
    return true;
  }
});
...
// Task 3
let celsiusToFahrenheit = temperatures.map((Celsius) => {
...
// Task 4
let WarmOrMildOrCold = temperatures.map((new_array) => {
  if (new_array >= 25) {
    return "Warm";
  } else if (new_array >= 20 && new_array <= 24) {
    return "Mild";
  } else if (new_array < 20) {
    return "Cool";
  }
});
console.log(WarmOrMildOrCold);
/*****************************************************************
